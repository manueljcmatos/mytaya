...
- [ ] **FOUND-01**: Site renders in Filipino (Tagalog) and English with auto-detection based on browser language
- [ ] **FOUND-02**: User can manually toggle between Filipino and English from any page
- [ ] **FOUND-03**: Each language has its own URL structure with proper hreflang tags for SEO
- [ ] **FOUND-04**: Supabase schema stores predictions with paired bilingual columns (title_tl/title_en, etc.)
- [ ] **FOUND-05**: Predictions table captures odds at prediction time for ROI calculation
- [ ] **FOUND-06**: User can toggle dark/light theme with persistence across sessions
- [ ] **FOUND-07**: Site is installable as PWA with offline support and push notification capability
